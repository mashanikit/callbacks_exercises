...
var purchases = transactions.filter(isPurchase)
...
var cashSales = transactions.filter(isCashSales)

function isCashSales(transaction) {
...
var creditPurchases = transactions.filter(isCreditPurchase)
...
function hasVendors(transaction) {
  if (transaction.vendor) {
    uniqueVendors.push(transaction.vendor)
  }
};

transactions.forEach(hasVendors);
